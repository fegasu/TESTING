...
public class Prueba1 {
    ...
    static double CalculoDescuento(){
        double x;
        x=(diasad*35000*equipos)+(diasad*35000*equipos);
        return (x);
    }
    ...
    static void MostrarDatos(){
        ...
        System.out.println("Valor Alquiler: $35000");
        System.out.println("No. DÝas adicionales:"+diasad);
        System.out.println("Valor dÝas adicionales: $"+CalculoAlquilerAdicionalDto());
